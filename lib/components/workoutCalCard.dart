...
class WorkoutCalCard extends StatefulWidget {
  @override
  _WorkoutCalCardState createState() => _WorkoutCalCardState();
}

class _WorkoutCalCardState extends State<WorkoutCalCard> {
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              ...
              print(caloriesBurned.toString());
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => WorkoutInsights()),
              );
