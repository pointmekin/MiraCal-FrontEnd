...
class WorkoutItemCard extends StatefulWidget {
  ...
  WorkoutItemCard({Key key, @required this.nameEn, this.cal}) : super(key: key);

  @override
  _WorkoutItemCardState createState() => _WorkoutItemCardState(nameEn, cal);
}
...
class _WorkoutItemCardState extends State<WorkoutItemCard> {
  ...
  final String nameEn;
  final String cal;
  _WorkoutItemCardState(this.nameEn, this.cal);
  // JSON Stuff
  File jsonFile;
  Directory dir;
...
//        mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
          ...
          InkWell(
            onTap: (){
              print('Food item card Clicked');
              String workoutName = nameEn;
              String workoutCal = cal;
              ...
              Navigator.push(
                ...
                MaterialPageRoute(builder: (context) => WorkoutDetails(), settings: RouteSettings(
                  arguments: foodInfo,
                ),),
              );
            },
