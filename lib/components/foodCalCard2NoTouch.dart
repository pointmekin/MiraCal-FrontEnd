...
class FoodCalCard2NoTouch extends StatefulWidget {
  @override
  _FoodCalCard2NoTouchState createState() => _FoodCalCard2NoTouchState();
}

class _FoodCalCard2NoTouchState extends State<FoodCalCard2NoTouch> with SingleTickerProviderStateMixin {
