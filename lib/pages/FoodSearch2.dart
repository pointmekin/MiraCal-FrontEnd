...
class FoodSearch2 extends StatefulWidget {
  @override
  _FoodSearch2State createState() => _FoodSearch2State();
}

class _FoodSearch2State extends State<FoodSearch2> {
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    hintText: 'Search...',
                    focusColor: Palette.miraCalPink,
                  ...
                  onChanged: (String value) {
                    setState(() {
                      query = value;
                      searchResults = searchingFood(query);
                    });
...
*/
  ...
  Widget buildSuggestions (BuildContext context) {
    ...
    var suggestionList = query.isEmpty && searchResults == null || fileContent['myFoodList'] == null

        ? []
        : fileContent['myFoodList']
              ...
              children: [
                ...
                suggestionList.length == 0
                    ...
                    : Padding(
                      ...
                      child: Row(
                        children: [
                          Text("My Menu", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Palette.miraCalPink)),
                        ],
                      ),
                    ),

                suggestionList.length == 0 || suggestionList == null
                    ? Container()
                    :ListView.builder(
...
//Text(suggestionList[index][0])
                ...
                searchResults.length == 0 ? Container() : Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 30),
                  child: Row(
                    children: [
                      Text("MiraCal Menu", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Palette.miraCalPink),),
                    ],
                  ),
                ),
                SizedBox(height: 5,),
                    ...
                    children: [
                      InkWell(
                        onTap: (){
                          ...
                          String foodCal =
                          searchResults[index][1].toString();
                          List<String> foodInfo = [foodName, foodCal];
                          print(foodName);
                          Navigator.push(
                            context,
                            ...
                            children: [
                                          ...
                                          children: <Widget>[
                                            Text(
                                              "Energy: " +
                                                  ...
                                                  [1].toString() == null
                                                  ? ""
                                                  : searchResults[index][1].toString() + " Cal",
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  color: Color(0xFFE39090)),
                                            ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(searchResults[index][2].substring(0,1).toString().toUpperCase() + searchResults[index][2].substring(1),
