                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              ((double.parse(workoutInfo[1])+ 0.0) * duration /30.0).round().toString() + " Calories",
                                              style: TextStyle(
                                                  fontSize: 16,
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text('Add ' + workoutInfo[0] + " to today's workout?"),
              ],
            ),
          ),
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                print("cal burnt from this workout is " + (double.parse(workoutInfo[1])*duration/30).round().toString());
                ...
                if (fileContent[workoutListDateKey] != null){
                  setState(() {
                    ...
                    List<String> toAdd = [(workoutInfo[0] + " " +duration.toString() + " min"), (double.parse(workoutInfo[1])*duration/30).round().toString()];
                  ...
                  setState(() {
                    tempCalWorkoutList= [[(workoutInfo[0] + " " +duration.toString() + " min"), (double.parse(workoutInfo[1])*duration/30).round().toString()]];
                  });
                  workoutList = tempCalWorkoutList.toString();
                ...
                if(fileContent[calWorkoutDateKey] != null) {
                  print("if executed");
                  jsonFileContent[calWorkoutDateKey] = (double.parse(jsonFileContent[calWorkoutDateKey]) +(double.parse(workoutInfo[1])*duration/30)).round().toString();
                } else {
                  print("else executed");
                  String newWorkoutCal = (double.parse(workoutInfo[1])*duration/30).round().toString();
                ...
                dailyInfo.calBurnedToday += (double.parse(workoutInfo[1])*duration/30).round();
